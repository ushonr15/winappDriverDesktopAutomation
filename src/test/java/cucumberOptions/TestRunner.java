...
@CucumberOptions(features = "featureFiles", glue = "stepDef", tags = "@run", monochrome = true, stepNotifications = true, plugin = {"pretty",
...
public class TestRunner {
    ...
    public static void AfterExecution() {
       ...
       /* Desktop desk = Desktop.getDesktop();
        try {
            desk.browse(new URI("file:///" +
                    System.getProperty("user.dir").replace("\\", "/") +
                    "/test-output/ExtentReport%20" + formattedDate +
